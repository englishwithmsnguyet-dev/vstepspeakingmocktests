...
for p in doc.paragraphs:
    ...
    if text == 'SPEAKING MOCK TEST 11':
        in_answers = True
        continue
    elif text == 'SPEAKING MOCK TEST 12' or text == 'SPEAKING MOCK TEST 13':
        break
...
with open('test11_format.txt', 'w', encoding='utf-8') as f:
    f.write("\n".join(lines))

print("Extracted test 11 format")
