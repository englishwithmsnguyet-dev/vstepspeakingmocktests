...
# These are the exact 22 Vietnamese translations for Test 06
translations = [
    # Q1 B1
...
for i, lc in enumerate(level_contents):
    ...
    if text_div:
        ...
        text_div.append(BeautifulSoup(trans_content, 'html.parser'))

with open(html_path, 'w', encoding='utf-8') as f:
    f.write(str(soup).replace('\\"', '"'))

print("Updated Vietnamese Translations!")
